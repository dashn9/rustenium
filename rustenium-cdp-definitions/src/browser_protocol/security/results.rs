...
impl TryFrom<serde_json::Value> for SetIgnoreCertificateErrorsResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for HandleCertificateErrorResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SetOverrideCertificateErrorsResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
