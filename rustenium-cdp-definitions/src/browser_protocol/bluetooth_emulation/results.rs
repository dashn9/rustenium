...
impl TryFrom<serde_json::Value> for SetSimulatedCentralStateResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulatePreconnectedPeripheralResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulateAdvertisementResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulateGattOperationResponseResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulateCharacteristicOperationResponseResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulateDescriptorOperationResponseResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for AddServiceResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for RemoveServiceResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for AddCharacteristicResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for RemoveCharacteristicResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for AddDescriptorResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for RemoveDescriptorResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
...
impl TryFrom<serde_json::Value> for SimulateGattDisconnectionResult {
    type Error = serde_json::Error;
    fn try_from(value: serde_json::Value) -> Result<Self, Self::Error> {
        serde_json::from_value(value)
    }
